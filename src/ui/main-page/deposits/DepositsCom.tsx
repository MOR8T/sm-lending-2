...
import {
  depositsAccountContents3,
} from "@/constants/business/const";
import DepositsAccount from "@/ui/business/depositsAccounts/DepositsAccount";
import { depositsAccountContents1 } from "@/constants/main-page/home-page";

export default function DepositsCom({ title }: DepositsAccountsT) {
