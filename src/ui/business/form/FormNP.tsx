...
export default function FormNP({
  ...
  return (
    <div className=" container flex md:gap-[127px] h-auto md:p-[96px] ">
      <div className=" flex flex-col md:gap-[17px] md:w-[365px]">
        <h1 className="md:head1 md:text-[38px] text-[22px] md:leading-[38px] leading-[28px]  font-bold text-[#FFFFFF]">
          {title}
        </h1>
        <h2 className="md:bodyBig mb-4.2 text-[#FFFFFF]">{subTitle}</h2>
      </div>
      <div className="md:max-w-[456px] w-full">
        ...
        <div className="flex md:gap-[32px] items-center">
          <button
