...
export const questions = [
  {
    title: "В каких валютах можно открыть депозит?",
    description: `
Депозит «Мақсад» можно открыть в двух валютах: доллар и сомони. Доход от депозита разделяется между клиентом и Алифом.
    Ожидаемый доход от депозита в год:
    — в сомони до 11%;
    — в долларах до 5%.
    ...
    Доход каждый месяц
    Доход начисляется ежемесячно с 1 по 10 число следующего месяца.
    Для более подробной информации можете оставить заявку на этом сайте. Мы с вами свяжемся и ответим на все вопросы.`,
  },
  {
    title: "Какова минимальная сумма для открытия депозита?",
    description: `
Минимальная сумма для открытия депозита — 1 сомони.
    `,
  },
  {
    title: "Какая комиссия взимается при снятии денег со счёта депозита?",
    description: `
Пополнив депозит наличными, после снятия с него денег комиссия отсутствует как в сомони, так и в долларах.
    В случае пополнения депозитного счёта безналичным путём возникают некоторые ограничения. Если вы снимете деньги в сомони в течение 30 дней, комиссия составит 0,9%. После 30 дней деньги можно снимать без комиссии.
    Те же условия и для снятия денег в долларах, только в данном случае другой срок. При снятии денег до 90 дней комиссия — 0,9%, после 90 дней — 0%.
    `,
  },
  {
    title: "Какой налог взимается с моего депозитного счёта?",
    description: `
В соответствии с требованиями налогового законодательства банк как налоговый агент обязан удержать налог в размере 12% с дохода, выплачиваемого банком (ст. 236 и 238 НК РТ).
    Ежемесячно с дохода депозитного счёта будет удерживаться налог 12%, а чистая прибыль будет доступна для снятия на карты «Корти милли», Visa или на кошелёк alif mobi, также доход может быть получен в кассах банка.
    `,
  },
  {
    title: "Как мне открыть депозит и куда надо будет подойти?",
    description: `
Если вы хотите открыть депозит в Алифе, можете с паспортом подойти в наш ближайший офис для оформление договора. Адреса здесь
    `,
  },
  {
    title: "Будет ли начисляться доход на замороженный депозит?",
    description: `
Когда вы оформляете рассрочку под залог депозита, вам как и раньше будет начисляться доходы каждый месяц. А получить его сможете после погашения рассрочки.
    `,
  },
];
