  ...
  return (
    <div className="container-2md text-[#262626]">
      ...
      <div className="flex justify-center">
        <div className="bg-[#F5F5F5] rounded-[12px] border border-[#3980A0] py-[24px] px-[12px] md:w-[294px] w-[327px] md:h-[133px] h-[123] flex flex-col items-center justify-center text-center">
